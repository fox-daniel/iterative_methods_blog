...
```
<figcaption>Code Block 1</figcaption>
...
<iframe id=iframe_embed style="border:none;" src="reservoir_histograms_initial_final.html" height="600" width="600" title="Initial and Final Stream Distributions"> </iframe>
<figcaption="caption">Figure 1</figcaption>
...
<iframe id=iframe_embed style="border:none;" src="reservoir_histogram_animation.html" height="400" width="600" title="Reservoir Distribution Approximate Stream Distribution"> </iframe>
...
```
<figcaption>Code Block 2</figcaption>
...
```
<figcaption>Code Block 3</figcaption>
...
<iframe id=iframe_embed style="border:none;" src="reservoir_means.html" height="400" width="600" title="Reservoir Distribution Approximate Stream Distribution"> </iframe>
...
```
<figcaption>Code Block 4</figcaption>
